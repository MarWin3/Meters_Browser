            ...
            <br>
		        <ul class="position-fixed">
					...
					src="<c:url value="/resources/image/gas.png"></c:url>">Gaz</a></li>
					 <li><a href="downloads/reports"><img
	         ...
	         <br>
		            <div class="justify-content-center" style:"width:100%" >
			         <table class="table-striped table-responsive table-light" style:"width:50%; margin: 0 auto;" >
				            <p>Liczniki wody</p>
				     <tr>
					    <th class="p-0">Nazwa pliku</th>

				    </tr>

				    <c:forEach var="tempReport" items="${reports}">
					    <c:url var="fileName" value="/download/pdf/">
						<c:param name="fileName"
							value="${tempReport}"></c:param>
					</c:url>
					<tr>
						<td class="p-auto"><a href="/download/pdf/${tempReport}">${tempReport}</a></td>
					</tr>
