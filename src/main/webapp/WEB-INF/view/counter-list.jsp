    ...
    <div class="container-fluid justify-content-center position-relative" style="width:80%; background-colour:">
        ...
        <div class="row position-relative" style="background-color:#313DA7;">
		    ...
		    <div>
				...
				<c:forEach var="tempElek" items="${elekt}">
					<c:url var="specCounterLink" value="/counter/showSpecCounter">
						<c:param name="counterSerialNumber"
							value="${tempElek.counterSerialNumber}"></c:param>
					</c:url>
					<tr>
						<td class="p-0">${tempElek.counterSerialNumber}</td>
						<td class="p-0">${tempElek.counterLocation}</td>
						<td class="p-auto">${tempElek.counterMedium}</td>
						<td class="p-auto">${tempElek.counterAddress}</td>
						<td class="p-auto">${tempElek.counterValue}</td>
						<td class="p-auto">${tempElek.counterUnit}</td>
						<td class="p-auto">${tempElek.counterDate}</td>
						<td class="p-auto"><a href="${specCounterLink}">Wczytaj</a></td>
			...
			<table class="table-striped text-center table-light">
				...
				<c:forEach var="tempCool" items="${cool}">
					<c:url var="specCounterLink" value="/counter/showSpecCounter">
						<c:param name="counterSerialNumber"
							value="${tempCool.counterSerialNumber}"></c:param>
					</c:url>
					<tr>
						<td class="p-0">${tempCool.counterSerialNumber}</td>
						<td class="p-0">${tempCool.counterLocation}</td>
						<td class="p-auto">${tempCool.counterMedium}</td>
						<td class="p-auto">${tempCool.counterAddress}</td>
						<td class="p-auto">${tempCool.counterValue}</td>
						<td class="p-auto">${tempCool.counterUnit}</td>
						<td class="p-auto">${tempCool.counterDate}</td>
						<td class="p-auto"><a href="${specCounterLink}">Wczytaj</a></td>
			...
			<table class="table-striped text-center table-light">
				...
				<c:forEach var="tempHeat" items="${heat}">
					<c:url var="specCounterLink" value="/counter/showSpecCounter">
						<c:param name="counterSerialNumber"
							value="${tempHeat.counterSerialNumber}"></c:param>
					</c:url>
					<tr>
						<td class="p-0">${tempHeat.counterSerialNumber}</td>
						<td class="p-0">${tempHeat.counterLocation}</td>
						<td class="p-auto">${tempHeat.counterMedium}</td>
						<td class="p-auto">${tempHeat.counterAddress}</td>
						<td class="p-auto">${tempHeat.counterValue}</td>
						<td class="p-auto">${tempHeat.counterUnit}</td>
						<td class="p-auto">${tempHeat.counterDate}</td>
						<td class="p-auto"><a href="${specCounterLink}">Wczytaj</a></td>
			...
			<table class="table-striped text-center table-light">
				...
				<c:forEach var="tempGas" items="${gas}">
					<c:url var="specCounterLink" value="/counter/showSpecCounter">
						<c:param name="counterSerialNumber"
							value="${tempGas.counterSerialNumber}"></c:param>
					</c:url>
					<tr>
						<td class="p-0">${tempGas.counterSerialNumber}</td>
						<td class="p-0">${tempGas.counterLocation}</td>
						<td class="p-auto">${tempGas.counterMedium}</td>
						<td class="p-auto">${tempGas.counterAddress}</td>
						<td class="p-auto">${tempGas.counterValue}</td>
						<td class="p-auto">${tempGas.counterUnit}</td>
						<td class="p-auto">${tempGas.counterDate}</td>
						<td class="p-auto"><a href="${specCounterLink}">Wczytaj</a></td>
