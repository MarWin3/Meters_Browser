        ...
        <div class="row position-relative" style="background-color:#313DA7;">
            ...
            <br>
		        <ul class="position-absolute" style="margin:auto;">
			        <li><a href="counter/list"><img src="<c:url value="/resources/image/all_counters.png"></c:url>">Wszystkie</a></li>
			        <li><a href="counter/electricity"><img src="<c:url value="/resources/image/electric.png"></c:url>">Elektryczne</a></li>
					...
					<li><a href="download/reports"><img src="<c:url value="/resources/image/report.png"></c:url>">Raporty</a></li>
		        </ul>
		         <button id="genAddress" type="button" class="btn btn-primary btn-lg btn-block" >Generuj raport</button>
                 <button id="genAddress" type="button" class="btn btn-primary btn-lg btn-block" >Generuj wykres</button>
		     </div>
